...
import com.left.template.utils.AnimatedImage;
import com.left.template.utils.AnimationDrawable;
...
public class SplashScreen extends AbstractMenuScreen {
	...
	public SplashScreen(TemplateGame game) {
		super(game);
	}
	...
	public void resize(int width, int height) {
		...
		int centerX = (int) (width * TemplateGame.getUIScaling() / 2);
		int centerY = (int) (height * TemplateGame.getUIScaling() / 2);
		logo.setPosition(centerX - logo.getWidth() / 2, centerY);
		arrows.setPosition(centerX - arrows.getWidth() / 2, centerY - arrows.getHeight());
	}
