...
import com.left.template.model.Time;
...
public class UIView implements Disposable {
	...
	private final TemplateView gridView;
	...
	public UIView(TemplateGame game, TemplateView gridView, TextureAtlas atlas, Skin skin) {
		this.game = game;
